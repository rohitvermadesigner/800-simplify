      ...
      <div className="relative max-w-7xl mx-auto py-8 md:py-16 px-4">
        <div className="text-center lg:px-64">
          ...
          <p className="text-[#4A5565] font-medium mt-2">
            Tailored auditing, accounting, tax, and PRO solutions — everything
            your business needs to stay compliant and in control.
          </p>
        </div>
          ...
          >
            {services.map((service) => (
              <SwiperSlide key={service.title} className="!h-auto flex">
                <div className="h-full w-full border-2 border-[#F3F4F6] rounded-[0.9rem] p-6 text-left bg-white">
